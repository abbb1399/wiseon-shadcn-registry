...
Thanks for your interest in contributing to WiseOn Shadcn Registry. We're happy to have you here.
...
```bash
git clone git@github.com:abbb1399/wiseon-shadcn-registry.git
```

### Navigate to project directory

```bash
cd wiseon-shadcn-registry
```
